...
- 混叠预览: status=gap, outputs=overlay_png
- 染色归一化: status=gap, outputs=normalized_slide

## Main Gaps

- Previous offline replay runtime any-hit rate: 0.372
- Previous offline replay canonical any-hit rate: 0.5755
- Planner primary drift counts: {'wish_14_intrahepatic_cholangiocarcinoma_cancer_detection': 3}
- Executed zero-output cases: ['demo_overlay_expected_gap', 'demo_macenko_expected_gap']

## Breakpoint Summary

- completed_no_output: 2
- preflight_contract_mismatch: 1
- empty_upstream_output: 1
- sequential_chain_failure: 1
